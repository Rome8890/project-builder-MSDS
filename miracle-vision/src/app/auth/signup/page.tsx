    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-400 text-sm">무료로 시작해보세요 · 신용카드 불필요</p>
        </div>
          ...
          <form action={signUpWithEmail} className="space-y-4">
            ...
            <div>
              <label htmlFor="password" className="block text-sm text-gray-400 mb-1.5">
                비밀번호 <span className="text-gray-600">(최소 8자)</span>
              </label>
              <input
                id="password"
                name="password"
            ...
            <div className="flex items-start gap-2.5">
              ...
              <label htmlFor="terms" className="text-xs text-gray-400 leading-relaxed">
                <span className="text-purple-400 cursor-pointer hover:underline">이용약관</span> 및{' '}
                <span className="text-purple-400 cursor-pointer hover:underline">개인정보처리방침</span>에 동의합니다.
                AI 이미지 생성 시 본인의 사진이 사용됨을 이해하고 동의합니다.
              </label>
            </div>
