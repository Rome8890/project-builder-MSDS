    ...
    <main className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section className="px-6 pb-24">
        <div className="max-w-5xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden border border-white/10 bg-gray-900/50 aspect-video flex items-center justify-center">
            ...
            <div className="relative text-center">
              ...
              <p className="text-gray-600 text-xs mt-1">실제 생성 이미지로 교체 예정</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={step}
                className="relative p-6 rounded-2xl border border-white/10 bg-gray-900/30 hover:border-purple-700/50 transition-colors"
              >
      ...
      <section className="px-6 py-24 border-t border-white/5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            ...
            <div className="p-6 rounded-2xl border border-purple-600 bg-purple-900/20 text-left relative overflow-hidden">
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                ...
                <li className="flex gap-2"><span className="text-purple-400">✓</span> SNS 공유 카드</li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-10">
            <Link
              href={user ? '/create' : '/auth/signup'}
              className="inline-flex px-8 py-4 bg-purple-600 hover:bg-purple-500 text-white font-semibold rounded-2xl transition-all hover:scale-105"
            >
              지금 무료로 시작하기
            </Link>
          </div>
